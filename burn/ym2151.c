...
#define RATE_STEPS (8)
static unsigned char eg_inc[19*RATE_STEPS]={
...
static unsigned char eg_rate_select[32+64+32]={	/* Envelope Generator rates (32 + 64 rates + 32 RKS) */
...
#define O(a) (a*1)
static unsigned char eg_rate_shift[32+64+32]={	/* Envelope Generator counter shifts (32 + 64 rates + 32 RKS) */
/* 32 dummy (infinite time) rates */
O(16),O(16),O(16),O(16),O(16),O(16),O(16),O(16),
O(16),O(16),O(16),O(16),O(16),O(16),O(16),O(16),
O(16),O(16),O(16),O(16),O(16),O(16),O(16),O(16),
...
void YM2151WriteReg(int n, int r, int v)
{
	...
	case 0x00:
		switch(r){
		case 0x01:	/* LFO reset(bit 1), Tst Register (other bits) */
			chip->tst = v;
...
static void ym2151_state_save_register( int numchips )
{
	...
	for (i=0; i<numchips; i++)
	{
		...
		state_save_register_UINT8  (buf1, i, "tst"     , &YMPSG[i].tst, 1);
